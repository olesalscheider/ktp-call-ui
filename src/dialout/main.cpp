...
int main(int argc, char **argv)
{
    ...
    app.setApplicationName(QStringLiteral("ktp-dialout-ui"));
    app.setApplicationDisplayName(i18n("KDE Telepathy Dialout Ui"));
    app.setOrganizationDomain(QStringLiteral("kde.org"));
    app.setApplicationVersion(KTP_CALL_UI_VERSION);
